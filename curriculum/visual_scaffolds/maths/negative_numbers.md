...
title: Negative Numbers — Temperature Number Line
...
```key
   ...
   -10°C
```
Mark the start and end temperatures, shade the difference.

**Horizontal number line** — for comparing or ordering integers:
```
-10  -5   0    5   10
 |----|----|----|----|
      ↑         ↑
...
**Real-world anchors** — always pair a negative number with a concrete context:
- Temperature: "It is −3°C outside" (below freezing)
- Sea level: "A submarine is 200 m below sea level (−200 m)"
- Money: "An account is $15 overdrawn (−$15)"
