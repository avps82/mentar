...
concepts:
  ...
  - id: us_g7_personification
    ...
    grounding: {}
    transfer_seeds:
      - "Which of these is personification (giving human qualities to something non-human)? A) the thunder rumbled loudly  B) the thunder grumbled angrily  C) the sun shone down on us  D) the old car started slowly. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
