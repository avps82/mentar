...
title: "English — Grade 5 (United States, general)"
tags: [US, english, "Grade 5", generic]
timestamp: "2026-08-11T00:00:00Z"
# Mentar curriculum template — United States, Grade 5 English (GENERIC pack).
...
concepts:
  ...
  - id: us_g5_synonyms_advanced
    label: "Synonyms (richer vocabulary)"                                       # AC9E5A alignment
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which word means the SAME as 'exhausted'? A) tired  B) enraged  C) strange  D) gigantic. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }

  - id: us_g5_antonyms_advanced
    label: "Antonyms (richer vocabulary)"                                       # AC9E5A alignment
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which word means the OPPOSITE of 'genuine'? A) scarce  B) stingy  C) fake  D) modern. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }

  - id: us_g5_word_classes_advanced
    label: "Adverbs, pronouns and verbs"                                       # AC9E5A alignment
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is an adverb (describes HOW something is done)? A) loudly  B) we  C) build  D) carry. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }

  - id: us_g5_compound_words
...
# United States — Grade 5 English (generic)

A board-agnostic English pack: universally-taught topics at roughly Grade 5 difficulty,
