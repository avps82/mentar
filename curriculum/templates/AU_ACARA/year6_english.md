...
concepts:
  ...
  - id: aue6_synonyms_nuanced
    ...
    grounding: {}
    transfer_seeds:
      - "Which word means the SAME as 'resilient'? A) precise  B) tough  C) thorough  D) unwilling. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  ...
  - id: aue6_word_classes_conjunctions_prepositions
    ...
    grounding: {}
    transfer_seeds:
      - "Which of these is a conjunction (joins two ideas)? A) under  B) during  C) between  D) because. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
