...
concepts:
  ...
  - id: au9_rectangle_area_expression
    ...
    verifier:
      ...
      checker: expression_equiv
    bkt_priors: { guess: 0.05, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: au9_simple_interest
    label: "Simple interest"
    strand: "Number and finance"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "$200 is invested at 10% simple interest per year for 2 years. How many dollars of interest does it earn?"
    verifier:
      answer_type: int
      checker: int_exact
  ...
  - id: au9_scale_factor
    ...
    grounding: {}
    transfer_seeds:
      - "Two triangles are similar with scale factor 3. A side of the small triangle is 6 cm. How long is the matching side of the large one?"
    verifier:
      answer_type: int
      checker: int_exact
    bkt_priors: { guess: 0.1, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: au9_scatter_trend
