...
title: "Science — Class 3 (India, general)"
tags: [IN, science, "Class 3", generic]
timestamp: "2026-08-14T00:00:00Z"
# Mentar curriculum template — India, Class 3 Science (GENERIC pack).
...
# display label, not a claim about what India teaches at Class 3.
# Items come from shared parametric generators (engine/generic_science_items.py),
# so the deterministic verifier scores every answer.

template_id: in-c3-science
country: IN
year_level: "Class 3"
subject: science
...
concepts:
  ...
  - id: in_c3_landforms
    ...
    grounding: {}
    transfer_seeds:
      - "Which of these is a RIVER? A) land with water all the way around it  B) fresh water flowing along a channel to the sea  C) a sandy shore where waves wash in  D) a high rocky peak with steep sides. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: in_c3_animal_groups
    label: "Grouping animals"
    strand: "Grouping living things"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is an INSECT (six legs)? A) an emu  B) a dog  C) an ant  D) a kangaroo. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: in_c3_material_groups
    label: "Grouping materials"
    strand: "Grouping materials"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is a NATURAL material? A) plastic made in a factory  B) wood from trees  C) concrete mixed for a path  D) paper in the recycling bin. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
...
# India — Class 3 Science (generic)

A board-agnostic science pack: universally-taught topics at roughly Class 3 difficulty,
