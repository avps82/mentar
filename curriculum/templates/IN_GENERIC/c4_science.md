...
title: "Science — Class 4 (India, general)"
tags: [IN, science, "Class 4", generic]
timestamp: "2026-08-14T00:00:00Z"
# Mentar curriculum template — India, Class 4 Science (GENERIC pack).
...
# display label, not a claim about what India teaches at Class 4.
# Items come from shared parametric generators (engine/generic_science_items.py),
# so the deterministic verifier scores every answer.

template_id: in-c4-science
country: IN
year_level: "Class 4"
subject: science
...
concepts:
  ...
  - id: in_c4_food_chain_roles
    label: "Producers and consumers"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is a producer (makes its own food, e.g. using sunlight)? A) a lion  B) a caterpillar  C) a shark  D) a sunflower. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }

  - id: in_c4_magnetic_materials
...
# India — Class 4 Science (generic)

A board-agnostic science pack: universally-taught topics at roughly Class 4 difficulty,
