...
title: "Maths — Class 5 (India, general)"
tags: [IN, mathematics, "Class 5", generic]
timestamp: "2026-08-11T00:00:00Z"
# Mentar curriculum template — India, Class 5 Mathematics (GENERIC pack).
...
# label, not a claim about what India teaches in Class 5.
...
concepts:
  ...
  - id: in_c5_add_sub_decimals
    label: "Adding and subtracting decimals"
    prereqs: [in_c5_decimal_place_value]
    grounding: {}
    transfer_seeds:
      - "What is 5.1 - 1.5?"
    verifier:
  ...
  - id: in_c5_percentage_of_quantity
  ...
  - id: in_c5_division_remainder_fraction
  ...
  - id: in_c5_division_remainder_decimal
    label: "Division with a remainder (as a decimal)"
    prereqs: [in_c5_division_remainder_fraction]
    grounding: {}
    transfer_seeds:
      - "What is 311 ÷ 20?"
    verifier:
...
# India — Class 5 Mathematics (generic)

A board-agnostic maths pack: universally-taught topics at roughly Class 5 difficulty,
