...
concepts:
  ...
  - id: in_c6_synonyms_nuanced
    ...
    grounding: {}
    transfer_seeds:
      - "Which word means the SAME as 'candid'? A) thorough  B) hesitant  C) tough  D) frank. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  ...
  - id: in_c6_antonyms_nuanced
    ...
    grounding: {}
    transfer_seeds:
      - "Which word means the OPPOSITE of 'transparent'? A) compulsory  B) verbose  C) rigid  D) opaque. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  ...
  - id: in_c6_conjunctions_prepositions
    ...
    grounding: {}
    transfer_seeds:
      - "Which of these is a conjunction (joins two ideas)? A) under  B) during  C) before  D) but. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
