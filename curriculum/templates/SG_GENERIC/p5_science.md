...
title: "Science — Primary 5 (Singapore, general)"
tags: [SG, science, "Primary 5", generic]
timestamp: "2026-08-14T00:00:00Z"
# Mentar curriculum template — Singapore, Primary 5 Science (GENERIC pack).
...
# display label, not a claim about what Singapore teaches at Primary 5.
# Items come from shared parametric generators (engine/generic_science_items.py),
# so the deterministic verifier scores every answer.

template_id: sg-p5-science
country: SG
...
concepts:
  ...
  - id: sg_p5_light_materials
    ...
    verifier:
      ...
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: sg_p5_solar_system
    label: "The solar system"
    strand: "Earth's place"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is a STAR? A) Jupiter  B) the object that orbits Earth each month  C) one of Jupiter's many orbiting companions  D) the Sun. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
...
# Singapore — Primary 5 Science (generic)

A board-agnostic science pack: universally-taught topics at roughly Primary 5 difficulty,
