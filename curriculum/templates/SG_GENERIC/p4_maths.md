...
title: "Maths — Primary 4 (Singapore, general)"
tags: [SG, mathematics, "Primary 4", generic]
timestamp: "2026-08-11T00:00:00Z"
# Mentar curriculum template — Singapore, Primary 4 Mathematics (GENERIC pack).
...
# label, not a claim about what Singapore teaches in Primary 4.
...
template_id: sg-p4-maths
country: SG
year_level: "Primary 4"
subject: mathematics
curriculum_standard: null                            # none claimed — see comment above
schema_version: "0.1"
label: "Maths — Primary 4 🇸🇬 (general)"
icon: "🔢"
description: "Place value, times tables, division facts and more — general maths at roughly Primary 4 level."
item_source: sg_p4_maths
...
concepts:
  ...
  - id: sg_p4_division_facts
    label: "Division facts"
    prereqs: [sg_p4_mult_facts]
    grounding: {}
    transfer_seeds:
      - "What is 15 ÷ 3?"
    verifier:
  ...
  - id: sg_p4_sharing_division
    label: "Sharing equally (word problems)"
    prereqs: [sg_p4_division_facts]
    grounding: {}
    transfer_seeds:
  ...
  - id: sg_p4_adding_fractions
    label: "Adding fractions (same denominator)"
    prereqs: [sg_p4_equivalent_fractions]
    grounding: {}
    transfer_seeds:
      - "What is 6/9 + 2/9?"
    verifier:
...
# Singapore — Primary 4 Mathematics (generic)

A board-agnostic maths pack: universally-taught topics at roughly Primary 4 difficulty,
