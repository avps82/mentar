...
concepts:
  ...
  - id: sg_s3_rectangle_area_expression
    ...
    verifier:
      ...
      checker: expression_equiv
    bkt_priors: { guess: 0.1, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: sg_s3_simple_interest
    label: "Simple interest"
    strand: "Number and finance"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "$1000 is invested at 10% simple interest per year for 2 years. How many dollars of interest does it earn?"
    verifier:
      answer_type: int
      checker: int_exact
    bkt_priors: { guess: 0.1, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: sg_s3_scale_factor
