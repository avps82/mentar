...
title: "English — Secondary 1 (Singapore, general)"
tags: [SG, english, "Secondary 1", generic]
timestamp: "2026-08-11T00:00:00Z"
# Mentar curriculum template — Singapore, Secondary 1 English (GENERIC pack).
...
# claim about what Singapore teaches in Secondary 1.
# Items come from shared parametric generators (engine/generic_english_items.py),
# so the deterministic verifier scores every answer.

template_id: sg-s1-english
country: SG
year_level: "Secondary 1"
subject: english
curriculum_standard: null                            # none claimed — see comment above
schema_version: "0.1"
label: "English — Secondary 1 🇸🇬 (general)"
icon: "📖"
description: "Idioms, formal/informal register, active/passive voice and personification — general English at roughly Secondary 1 level."
item_source: sg_s1_english
...
concepts:
  ...
  - id: sg_s1_personification
    label: "Personification"                                       # AC9E7A alignment
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is a literal statement? A) the old car groaned to a start  B) the wind blew through the trees  C) the thunder grumbled angrily  D) the wind whispered through the trees. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
...
# Singapore — Secondary 1 English (generic)

A board-agnostic English pack: universally-taught topics at roughly Secondary 1 difficulty,
