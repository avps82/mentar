...
title: "Science — Primary 4 (Singapore, general)"
tags: [SG, science, "Primary 4", generic]
timestamp: "2026-08-14T00:00:00Z"
# Mentar curriculum template — Singapore, Primary 4 Science (GENERIC pack).
...
# display label, not a claim about what Singapore teaches at Primary 4.
# Items come from shared parametric generators (engine/generic_science_items.py),
# so the deterministic verifier scores every answer.

template_id: sg-p4-science
country: SG
...
concepts:
  ...
  - id: sg_p4_state_change_heat
    ...
    verifier:
      ...
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
  - id: sg_p4_sun_moon_earth
    label: "Sun, Earth and Moon"
    strand: "Earth and space"
    prereqs: []
    grounding: {}
    transfer_seeds:
      - "Which of these is true of the SUN? A) it is the only one of the three with life on it  B) it shines only by reflecting sunlight  C) it circles the Earth about once a month  D) it is far bigger than the other two. Answer with the letter."
    verifier:
      answer_type: mc4
      checker: mc_choice
    bkt_priors: { guess: 0.25, slip: 0.1, learns: 0.2, forgets: 0 }
...
# Singapore — Primary 4 Science (generic)

A board-agnostic science pack: universally-taught topics at roughly Primary 4 difficulty,
