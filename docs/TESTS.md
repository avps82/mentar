...
- **PASS:** All assertions green. **Implemented:** `tests/engine/test_bkt.py` (T3.3 ✅ 2026-06-14; 11 invariant tests as of 2026-09-02) + `tests/dialogue/test_bkt_observations.py` (W3.3 §3.3 one-observation-per-attempt, 4 tests, 2026-09-02) + `tests/dialogue/test_deferred_probe.py` (§6 G7 deferred graduation probe, 5 tests) + `tests/db/test_store.py` (params persisted, §6 B1).
