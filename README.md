...
Shipping today (157 templates, 934 nodes). **Read the counts, not the year ranges** — a
year listed below may hold as few as 3–7 topics, and an honest per-year gap report (currently: ZERO AU gaps) against
