...
Shipping today (148 templates, 641 nodes). **Read the counts, not the year ranges** — a
...
|---|---|---|
| `AU_ACARA/` | Maths Y2–10 (4–7 topics/yr) + senior courses: all four courses Y11–12: Essential & General (10 topics each), Methods (13–14 incl. the absorbed algebra nodes), Specialist (10 each) · English Y2–12 (3–4 topics/yr) · Science Y2–10 (3 topics/yr) · Physics/Chemistry/Biology Y11–12 (3 topics each) | ACARA v9 (CC BY 4.0) for F–10; senior courses: none claimed |
