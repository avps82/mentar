...
purpose: Help re-explanation in the CONCRETE representation (real objects); simple, age-framed, worked to the answer — the FSM presents the re-check (SPEC §13.2).
fsm_state: HELP_REEXPLAIN (modality = concrete)
version: 1a41b1b6884f
---
