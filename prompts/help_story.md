...
purpose: Help re-explanation as a short STORY; simple, age-framed, worked to the answer — the FSM presents the re-check (SPEC §13.2).
fsm_state: HELP_REEXPLAIN (modality = story)
version: bae0a7761382
---
...
Re-explain {{concept}} as a tiny, cheerful STORY (two friendly characters share something) — two or three sentences, nothing scary.
